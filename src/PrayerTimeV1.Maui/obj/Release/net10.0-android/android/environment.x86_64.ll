...
@aot_dso_cache = dso_local local_unnamed_addr global [864 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.94_name, ; name: libaot-System.Threading.Channels.dll.so
		ptr null; void* handle
	}, ; 2
	%struct.DSOCacheEntry {
...
@.DSOCacheEntry.94_name = private unnamed_addr constant [40 x i8] c"libaot-System.Threading.Channels.dll.so\00", align 16
